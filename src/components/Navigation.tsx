...
export default function Navigation() {
  ...
  return (
    <nav className="relative flex items-center justify-between h-16">
      ...
      <div
        ref={mobileMenuRef}
        className={`lg:hidden absolute top-full right-0 w-full transition-all duration-200 ease-in-out ${
          isMobileMenuOpen ? 'max-h-screen opacity-100 visible' : 'max-h-0 opacity-0 invisible'
        }`}
      >
        <div className="px-2 pt-2 pb-3 space-y-1 bg-black/90 backdrop-blur-sm border-t border-gray-800">
